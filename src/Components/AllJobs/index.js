...
class AllJobs extends Component {
    ...
    onGetProfileDetails = async() => { 
        ...
        if (responseProfile.ok === true) {
            ...
            const updatedDataProfile = fetchedDataProfile.map(eachIten => ({
    ...
    onGetJobDetails = async () => {
        ...
        if (responseJobs.ok === true) {
            ...
            const updatedDataJobs = fetchedDataJobs.jobs.map(eachIten => ({
    ...
    onGetInputOption = event => { 
        ...
        if (inputNotInList.length === 0) {
            ...
            const filteredData = checkboxInputs.filter( 
                eachItem => eachIten != event.target.id,
            )
            this.setState(
                // eslint-disable-next-line no-unused-vars
        ...
        return noJobs ? (
            <div className="no-jobs-container">
                <img
                    ...
                    src="https://assets.ccbp.in/frontend/react-js/no-jobs-ing.png"
                    alt="no jobs"
                />
                <h1>No jobs found</h1>
